...
describe('ProjectCard', () => {
  it('affiche le nom, le rôle, la stack et les liens', () => {
    const wrapper = mount(ProjectCard, { props: { project: full } })
    expect(wrapper.text()).toContain('Abloue')
    expect(wrapper.text()).toContain('Projet collaboratif')
  ...
  it('omet rôle et liens quand ils sont absents', () => {
    ...
    expect(wrapper.find('.project-card__role').exists()).toBe(false)
